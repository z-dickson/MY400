...
- **Racial avoidance theory**: The tendency to avoid interactions with individuals of a different race [@willis1966initial; @hendricks1976race; @brown1981shared]
...
- **Submission Deadline:** Thursday 6th November, 4pm
...
## Example of a basic regression with a binary treatment 
...
g + theme_fivethirtyeight() +
  labs(title = "Simple regression with binary treatment") + xlim(-.1, .7) + geom_vline(xintercept = 0, linetype = "dashed", color = "red")
