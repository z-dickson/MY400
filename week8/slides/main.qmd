...
- Discuss with your group: What comes to mind when you hear "case study"? Share an example from your field of study.
...
- In pairs, brainstorm how you would justify the selection of a specific case (e.g., a country, policy, or organization) for a given research topic
...
- Discuss: What makes this case selection compelling? 
- How could the authors improve their justification?



# Comparison in Case Studies

<br>

**Key Insight**:

- Comparison offers leverage in addressing research questions (e.g., most similar vs. most different design)
- "Hard" test cases can help identify causal mechanisms

**Group Activity**:
- Pick two cases relevant to your research area. Discuss in your group:

  - How are they similar?
  - How are they different?
  - What can be learned from their comparison?



# Designing Single-Case Studies

<br>

**Key Insight**:

- Single cases can be as insightful as multi-case studies if justified appropriately.

**Group Activity**:

- Identify a potential single case for your research. Discuss:
  
  - What is it a case of?
  - Why is it compelling?
  - How will it address your research question?
...
- Explicitly discuss methodological choices (e.g., why one case, two cases, or more?).

**Group Activity**:

Thinking about the research topic that you have identified in your formative assignment, reflect upon designing research and justifying case selection for: 

  - n = 1 (single case),
  - n = 2 (comparative),
  - n > 2 (e.g., multi-case or quantitative).
...
- If you need to speak outside of these hours, please email me to arrange a meeting
  - If I don't respond within 24 hours, please send me a reminder email
