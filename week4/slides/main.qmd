...
# Literature Review: Key Components
...
2. **Main Arguments**:
    ...
    - **Assumptions**, **logic**, and **methodology**.
...
- Facebook advertising data covers a large number of countries (because of high worldwide Facebook penetration) and can provide gender-based country-level estimates. We also have national-level development indicators that are strongly correlated with digital divides. ​
