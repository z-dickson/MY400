...
- What are the key differences between gap-spotting and problematization in constructing research questions?
	- Discuss how each approach impacts the development of significant and innovative theories in organizational studies.
...
- Why is gap-spotting the dominant approach in research question formulation, despite the emphasis on theory challenging for creating interesting research?
	- What social norms or academic pressures reinforce the preference for gap-spotting?
...
- How might problematization contribute to more interesting and influential research, and what are the challenges associated with it?
	- Reflect on why problematization is less frequently used despite its potential benefits.
